#!/usr/bin/env python3
"""Acceptance checks for the active v117 manuscript and submission files."""
...
REPORTS = ROOT / "paper/draft/review_versions/2026-07-15_v117_scientific_revision/reports"
ACTIVE = [
...
def main() -> None:
    ...
    checks["chinese_review_pdf_exists"] = (DRAFT / "main_中文版_v117_审阅稿.pdf").exists()
    ...
    lines = ["# v117 manuscript acceptance gate", "", f"Status: **{result['status'].upper()}** ({result['passed']}/{result['total']})", ""]
